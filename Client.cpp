...
// Yapıcı fonksiyona isAuthenticated(false) eklendi
Client::Client(int clientFd)
    : fd(clientFd), nickname(""), username(""), hostname(""), buffer(""), isRegistered(false), isOperator(false), isAuthenticated(false) {}
...
bool Client::getIsAuthenticated() const { return isAuthenticated; } // YENİ EKLENDİ
...
void Client::setIsAuthenticated(bool auth) { isAuthenticated = auth; } // YENİ EKLENDİ
